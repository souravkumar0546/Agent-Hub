...
CATALOG: list[AgentDef] = [
    AgentDef(
        ...
        tagline="Live milestone tracking \u2014 every slip, owner, and dependency surfaced the moment it happens.",
        category="PMO",
        icon="chart",
    ...
    AgentDef(
        ...
        tagline="Board-ready minutes in 5 minutes — transcript, decisions, and owner-tagged action items.",
    ...
    AgentDef(
        ...
        tagline="Self-serve answers on leave, Form 16, comp, and policy — sourced from your handbook, never invented.",
        category="HR",
        icon="users",
    ...
    AgentDef(
        ...
        tagline="One pane on the entire hiring funnel \u2014 pipeline depth, interview load, and time-to-offer at a glance.",
        category="Talent",
        icon="trending",
    ...
    AgentDef(
        ...
        tagline="Personalised L&D plans built from each employee's role, skills gap, and recent reading.",
        category="L&D",
        icon="book",
    ...
    AgentDef(
        ...
        tagline="Parent-child vendor maps with spend leakage and supplier-match suggestions, audit-trailed.",
    ...
    AgentDef(
        ...
        tagline="Real-time R&D and clinical inventory across sites — with demand forecasts your buyers can act on.",
        category="R&D",
        icon="flask",
    ...
    AgentDef(
        ...
        tagline="Sales-ready answers in seconds \u2014 capability lookup, deck search, and citable reference pulls.",
        category="Commercial",
        icon="chat",
    ...
    AgentDef(
        ...
        tagline="Continuous external scanning — new molecules, competitor moves, and trend signals, every source cited.",
        category="Commercial",
        icon="pipeline",
    ...
    AgentDef(
        ...
        tagline="Drafts FDA 483 responses with precedent citations — defensible, traceable, faster than starting cold.",
        category="Compliance",
        icon="shield",
