...
CATALOG: list[AgentDef] = [
    ...
    AgentDef(
        ...
        tagline="Drafts a full RCA report in about an hour. Every line links back to the SOP it came from. Export to Word.",
        category="Compliance",
        icon="search",
    ...
    AgentDef(
        ...
        tagline="Sorts thousands of new records into your taxonomy in minutes. You can review and override every call.",
    ...
    AgentDef(
        ...
        display_name="Forge",
        name="Master Builder",
        tagline="Turns messy classifications into a clean master dataset. Review each row, fix anything inline.",
        category="Data Management",
        icon="flask",
        default_departments=(),
        module="app.dma",
    ...
    AgentDef(
        ...
        tagline="Adds the attributes you're missing from outside sources. Keeps the original value so you can see what changed.",
        category="Data Management",
        icon="book",
        default_departments=(),
        module="app.dma",
